...
class Constant:
    ...
    HISTORY_TABLE_UNIQUE_ID_INDEX_NAME = 'stage_unique_id_index'
    HISTORY_TABLE_UNIQUE_ID_INDEX_HASH_KEY = 'stage_name'
    HISTORY_TABLE_UNIQUE_ID_INDEX_RANGE_KEY = 'unique_id'
